    ...
    <main className="min-h-screen bg-white">
      ...
      <div className="max-w-[1400px] mx-auto px-6 py-8 grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        <div className="lg:col-span-3 space-y-4">
          ...
          >
            <summary className="px-4 py-2.5 text-xs text-gray-600 cursor-pointer hover:text-gray-900 font-medium">
            ...
            <div className="p-4">
              <textarea
                ...
                spellCheck={false}
                className="w-full h-80 text-xs bg-gray-50 border border-gray-200 rounded-md p-2 font-mono text-gray-800 focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500"
              />
          ...
          <div className="text-xs text-gray-600 border border-gray-200 rounded-lg p-4 leading-relaxed bg-gray-50/50">
            <div className="font-medium text-gray-900 mb-1">How to read this</div>
            ...
            timings. Use the{" "}
            <span className="text-gray-900 font-medium">Force</span> dropdown to
      ...
      <footer className="max-w-[1400px] mx-auto px-6 py-10 text-xs text-gray-500 text-center border-t border-gray-100 mt-8">
